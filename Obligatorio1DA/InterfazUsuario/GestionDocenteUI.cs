...
namespace InterfazUsuario
{
    public partial class GestionDocenteUI : Form
    {
        ...
        private void cargarListaDocente()
        {
            ...
            {
                ListViewItem itemDocente = new ListViewItem(docente.Id.ToString());
        ...
        private void listaDocentes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                entradaCIDocente.Text = docenteSeleccionado[0].SubItems[1].Text;
        ...
        {
            mantenimientoDocente.BajarDocente(idDocenteSeleccionado);
        ...
        {
            AsignarMateriaUI.idDocenteSeleccionado = idDocenteSeleccionado;
